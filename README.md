...
`pip install git+https://github.com/jvlevinson/BetterWhisperX.git`

If already installed, update package to most recent commit

`pip install git+https://github.com/jvlevinson/BetterWhisperX.git --upgrade`

If wishing to modify this package, clone and install in editable mode:
```
$ git clone https://github.com/jvlevinson/BetterWhisperX.git
$ cd whisperX
$ pip install -e .
```
